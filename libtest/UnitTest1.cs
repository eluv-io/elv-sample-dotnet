    ...
    public class Tests
    {
        ...
        public void TestToken()
        {
            try
            {
                ...
                ContentFabricClient bcp = new(pwd, "demov3", "iq__9NTxhagnVXo3spsfBJkw3Y2dc2c", "ilib2f2ES7AB6rZVvLQqBkLNqAj7GTMD");
        ...
        public void TestContent()
        {
            try
            {
                ...
                var content = ContentFabricClient.CreateContent(spaceService, ct, libAddress);
                content.Wait();
